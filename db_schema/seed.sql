-- ============================================================
--  DUMMY / SEED DATA
--  Load AFTER schema.sql, in a fresh database.
--  Passwords below are bcrypt hashes of "password123" for every
--  demo user (see README for login table).
-- ============================================================
...
-- ------------------------------------------------------------
-- APP USERS  (all demo passwords = "password123")
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- CASE ASSIGNMENT (M:N staff <-> case)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- CLINICAL EXAMINATION (subtype of event 1 & 3)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- SEXUAL ASSAULT FINDING (extension of clinical_examination 3)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- POSTMORTEM (subtype of event 2 & 5)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- SKELETAL EXAMINATION (subtype of event 4)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- GRIEVOUS HURT LOOKUP (Penal Code s.311 (a)-(i))
-- ------------------------------------------------------------
INSERT INTO grievous_hurt_type (clause_code, description) VALUES
 ...
 ('h', 'Any hurt which endangers life or causes the sufferer to be in severe bodily pain, or unable to follow ordinary pursuits, for 20 days or more'),
...
-- ------------------------------------------------------------
-- LAB REQUEST ORGAN/TISSUE (histopathology-style requests)
-- ------------------------------------------------------------
...
INSERT INTO lab_result
 (lab_request_id, laboratory_no, result_date, received_by, lab_notes, findings, reported_by, checked_by, sent_on_date) VALUES
 (1, 'GA-LAB/9021', '2026-06-10 10:00', 'Mr. D.S. Karunaratne',
 ...
 (2, 'GA-LAB/9022', '2026-06-15 10:00', 'Mr. D.S. Karunaratne',
 ...
 (4, 'GA-LAB/9023', '2026-06-16 10:00', 'Mr. D.S. Karunaratne',
 ...
 (5, 'GA-LAB/9024', '2026-06-18 10:00', 'Mr. D.S. Karunaratne',
...
-- Notes: lab_request 3 (histopathology), 6 (MRI) and 7 (cardiac histo) still pending -> no lab_result row (illustrates 'Awaiting Lab' status)
